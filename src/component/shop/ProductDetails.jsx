  ...
  return (
    <>
      <div className="relative">
          ...
          <div className="absolute z-[999]">
            <div className="fixed">
              <div className="flex justify-center items-center backdrop-blur-lg h-screen w-screen">
                <div className="bg-white w-[65rem] border-2 relative">
                  <div className="py-10 px-5">
                    ...
                    <div className="flex">
                      ...
                      <div className="px-7 w-[50%]">
                        <div className="border-b-2 border-black pb-5 space-y-1">
                          <p className="text-sm">Your Bag</p>
                          <p>1 item</p>
                          <div className="">
        ...
        <Header />
        <div className="w-[80%] mx-auto flex my-16">
          ...
          <div className="pl-10 py-7 ">
            ...
            <div className="grid grid-cols-5 max-w-[500px] mt-10 ">
              {product.sizes.map((size, index) => (
                <div
                  key={index}
                  className={`border-stone-200 flex justify-center p-4 border-solid items-center border-[1px] cursor-pointer ${
                    selectedSize === size
